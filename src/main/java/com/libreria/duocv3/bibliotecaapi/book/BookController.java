...
@Tag(
        name = "Books (Public)",
        description = "Catálogo público de libros. Búsquedas y obtención de detalle sin autenticación."
)
@CrossOrigin(origins = "*")
@RestController
...
public class BookController {
    ...
    public Page<BookResponse> list(
            ...
            @Parameter(description = "Texto a buscar en título o autor")
            @RequestParam(required = false) String q,

            @Parameter(description = "Categoría exacta del libro")
    ...
    @Operation(
            ...
            description = "Retorna el detalle de un libro de forma pública."
    )
    @ApiResponse(
            responseCode = "200",
